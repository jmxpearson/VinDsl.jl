...
export VBModel,
    RVType, RScalar, RVector, RMatrix, RReal, RPositive, RNegative, RBounded, RProbability, RCorrelation, RCovMat, RUnitVec, ROrdered, RRealVec, RCholFact, @advi_declarations, @advi_model, @ELBO,
