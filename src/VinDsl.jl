...
export VBModel,
    RVType, RScalar, RVector, RMatrix, RReal, RPositive, RNegative, RBounded, RProbability, RCorrelation, RCovMat, RRealVec, RCholFact, @advi_declarations, @advi_model, @ELBO,
